...
const helpDocs = [
  {
    ...
    keywords: ["flujo", "plan semanal", "reloj", "mis marcas", "observacion", "validacion", "dashboard", "reporte", "rrhh"],
    ...
    steps: [
      ...
      "RRHH trabaja el día desde Dashboard y Validación de jornales: KPIs, operaciones, marcas, previsiones y observaciones.",
      "Las observaciones se corrigen editando marcas, pasando a plan semanal, marcando ausente o aprobando con comentario.",
  ...
  },
  {
    ...
    keywords: ["dashboard", "kpi", "dia", "mes", "operaciones y marcas", "rrhh", "alertas", "documentos", "observaciones"],
    summary: "Mesa diaria de trabajo para RRHH: KPIs, operaciones, marcas, previsiones y observaciones.",
    steps: [
      "Entrá a Dashboard.",
  ...
  },
  {
    ...
    summary: "Corrección o carga manual de marcas desde Dashboard o Validación de jornales.",
    steps: [
      ...
      "Después de guardar, el sistema refresca marcas, observaciones, jornales y dashboard.",
      "Si una marca manual corrige una observación, esa observación deja de representar la marca original sin revisar.",
    ],
  },
  {
    id: "observaciones-dashboard",
    type: "Proceso",
    title: "Ver y aprobar observaciones",
    keywords: ["observaciones", "aprobar observacion", "ver detalle", "editar observacion", "marca fuera ubicacion", "marca incompleta", "vacio", "ausente"],
    summary: "Tratamiento de inconsistencias detectadas sobre marcas y planificación.",
    steps: [
      "Desde Dashboard, tocá Ver en el KPI Observaciones del día o del mes.",
      "Para trabajar con filtros más amplios, entrá a Validación de jornales.",
  ...
  },
  {
    ...
    keywords: ["operaciones", "aprobar operaciones", "rechazar operaciones", "editar operacion", "categoria operacion", "tipo operacion", "franja", "rechazada"],
    ...
    steps: [
      ...
      "Revisá operador, categoría/tipo, franja, proyecto, observación, valor y estado.",
      ...
      "La edición permite cambiar categoría/tipo y franja; el valor se recalcula según la matriz de costos.",
  ...
  {
    id: "estados-validacion-jornales",
    type: "Proceso",
    title: "Entender estados de validación",
    keywords: [
      "estado validacion",
      "pendientes",
      "requiere revision",
      "todos los estados",
      "validados",
      "validados con observacion",
      "rechazados",
      "anulada",
      "jornales",
    ],
    summary: "Definición operativa de cada estado del filtro de Validación de jornales.",
    steps: [
      "Pendientes: jornales que todavía requieren acción de RRHH. Aplica cuando hay un turno previsto con marcas no validadas, marcas faltantes, diferencias relevantes, observaciones pendientes o casos que todavía no fueron aprobados o rechazados.",
      "Requiere revisión: casos donde el sistema detectó algo que no debería aprobarse automáticamente y necesita mirada humana. Por ejemplo: marca incompleta, tramo raro, marca fuera de ubicación, marca en día o estado no esperado, o situaciones donde no alcanza con la comparación simple.",
      "Todos los estados: muestra todo lo que entra en la validación: pendientes, revisados, aprobados, rechazados, validados con observación y otros estados disponibles. Sirve para auditar un período completo.",
      "Validados: jornales ya aprobados. Puede incluir validación automática o manual según el caso. En la práctica, RRHH o el sistema ya dio por bueno ese jornal.",
      "Validados con observación: jornales aprobados, pero que tenían alguna observación asociada. Ejemplo: marca fuera de ubicación, llegada tarde, salida antes de horario o diferencia contra el plan. Se valida igual, pero queda documentada la salvedad.",
      "Rechazados: jornales que RRHH decidió no validar. Aplica cuando la marca o el tramo no se aceptan como jornal válido para liquidación o control.",
      "Anulada: estado técnico para marcas anuladas. La marca no se borra de la base; queda anulada para mantener trazabilidad.",
    ],
  },
  {
    id: "publicar-dia",
  ...
  },
  {
    ...
    steps: [
      ...
      "Cuando un turno se regulariza desde una observación y no hay actividad informada, queda como LOGISTICA.",
  ...
  {
    id: "filtrar-observaciones",
    type: "Proceso",
    title: "Filtrar y revisar observaciones",
    keywords: ["observaciones", "aprobar", "editar", "detalle", "ubicación", "vacío", "tarde", "antes de lo previsto", "falta entrada", "falta salida"],
    ...
    steps: [
      ...
      "Las observaciones de falta de entrada o falta de salida se trabajan por tramo observado.",
    ],
  },
  {
  ...
  },
  {
    ...
    steps: [
      ...
      "Podés editar categoría/tipo y franja de una operación cuando haga falta corregirla.",
      "El valor se calcula desde la matriz de costos por categoría/tipo y franja.",
  ...
  },
  {
    ...
    steps: [
      ...
      "Definí ubicaciones admitidas y si generan observación.",
