...
FIRST_ACCESS_SECURITY_CODE = os.environ.get("PLANNER_FIRST_ACCESS_SECURITY_CODE", "LANG")
...
EXTERNAL_PERSONNEL_URL = os.environ.get("PLANNER_EXTERNAL_PERSONNEL_URL", "").strip()
...
EXTERNAL_AUTH_ALLOW_COOKIELESS = os.environ.get("PLANNER_EXTERNAL_AUTH_ALLOW_COOKIELESS", "0").lower() in {"1", "true", "yes", "si"}
